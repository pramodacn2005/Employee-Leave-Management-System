/**
 * Email template for employee when leave is approved
 */
export const leaveApprovedTemplate = (leaveData) => {
        ...
        <table role="presentation" style="max-width: 600px; width: 100%; background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); overflow: hidden;">
          ...
          <tr>
            <td style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); padding: 40px 30px; text-align: center;">
              ...
              <p style="margin: 8px 0 0 0; color: #d1fae5; font-size: 14px;">Leave Request Approved ✓</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <p style="margin: 0 0 30px 0; color: #64748b; font-size: 16px; line-height: 1.6;">
                Great news! Your leave request has been <strong style="color: #10b981;">approved</strong> by ${managerName || 'your manager'}.
              </p>

              <!-- Status Badge -->
              <div style="background-color: #d1fae5; color: #10b981; padding: 12px 20px; border-radius: 8px; margin-bottom: 30px; text-align: center;">
                <span style="font-weight: 600; font-size: 14px; text-transform: uppercase; letter-spacing: 0.5px;">✓ Status: APPROVED</span>
              </div>
              ...
              <div style="background-color: #eff6ff; border-left: 4px solid #2563eb; border-radius: 8px; padding: 20px; margin-bottom: 30px;">
                <p style="margin: 0 0 8px 0; color: #1e40af; font-size: 12px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;">Manager Comment</p>
              ...
              <p style="margin: 0; color: #94a3b8; font-size: 14px; line-height: 1.6;">
                Enjoy your time off! Your leave balance has been updated accordingly.
              </p>
            </td>
          </tr>
